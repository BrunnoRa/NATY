...
$desktopShortcut.IconLocation = (Join-Path $resolvedRoot "Naty.exe") + ",0"
...
$menuShortcut.IconLocation = (Join-Path $resolvedRoot "Naty.exe") + ",0"
$menuShortcut.Save()
...
$uninstallShortcut.IconLocation = (Join-Path $resolvedRoot "Naty.exe") + ",0"
